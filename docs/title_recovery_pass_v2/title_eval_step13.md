...
Input: `data/jobs/jobs_titled_en_recovery_v2.jsonl`
...
## Other Clusters
- other_long_tail: 36194 | action=keep_other
- skilled_trades: 1682 | action=add_new_normalized_title
- design_creative: 1353 | action=map_to_existing
- healthcare_clinical: 998 | action=add_new_normalized_title
...
## Sample Files
- matched: `docs/title_recovery_pass_v2/sample_title_matched_step13.jsonl`
- other: `docs/title_recovery_pass_v2/sample_title_other_step13.jsonl`
- clusters: `docs/title_recovery_pass_v2/title_other_clusters_step13.json`