...
Input: `data/jobs/jobs_titled_en_recovery_v1.jsonl`
...
- Entry-Level Auto Technician: 23
- Licensed Practical Nurse (LPN): 23
- Medical Assistant: 22

## Other Clusters
- other_long_tail: 35798 | action=keep_other
- skilled_trades: 2065 | action=add_new_normalized_title
- design_creative: 1353 | action=map_to_existing
- healthcare_clinical: 996 | action=add_new_normalized_title
- compliance_risk: 633 | action=add_new_normalized_title
- logistics: 500 | action=add_new_normalized_title
- education: 468 | action=add_new_normalized_title
- retail_sales: 383 | action=add_new_normalized_title
- customer_service: 197 | action=map_to_existing
- engineering_leadership: 94 | action=add_new_normalized_title

## Sample Files
- matched: `docs/title_recovery_pass_v1/sample_title_matched_step13.jsonl`
- other: `docs/title_recovery_pass_v1/sample_title_other_step13.jsonl`
- clusters: `docs/title_recovery_pass_v1/title_other_clusters_step13.json`