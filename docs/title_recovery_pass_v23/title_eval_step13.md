...
Input: `data/jobs/jobs_titled_en_recovery_v23.jsonl`
...
## Other Clusters
- other_long_tail: 34960 | action=keep_other
- skilled_trades: 1207 | action=add_new_normalized_title
- design_creative: 1011 | action=map_to_existing
- healthcare_clinical: 697 | action=add_new_normalized_title
- compliance_risk: 430 | action=add_new_normalized_title
- logistics: 414 | action=add_new_normalized_title
- education: 323 | action=add_new_normalized_title
...
## Sample Files
- matched: `docs/title_recovery_pass_v23/sample_title_matched_step13.jsonl`
- other: `docs/title_recovery_pass_v23/sample_title_other_step13.jsonl`
- clusters: `docs/title_recovery_pass_v23/title_other_clusters_step13.json`