...
Input: `data/jobs/jobs_titled_en_recovery_v14.jsonl`
...
## Other Clusters
- other_long_tail: 35331 | action=keep_other
- skilled_trades: 1400 | action=add_new_normalized_title
- design_creative: 1096 | action=map_to_existing
- healthcare_clinical: 831 | action=add_new_normalized_title
...
## Sample Files
- matched: `docs/title_recovery_pass_v14/sample_title_matched_step13.jsonl`
- other: `docs/title_recovery_pass_v14/sample_title_other_step13.jsonl`
- clusters: `docs/title_recovery_pass_v14/title_other_clusters_step13.json`