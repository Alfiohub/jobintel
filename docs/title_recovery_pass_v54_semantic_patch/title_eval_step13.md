...
Input: `data/jobs/jobs_titled_en_recovery_v54_semantic_patch.jsonl`
...
## Other Clusters
- other_long_tail: 32069 | action=keep_other
- skilled_trades: 1142 | action=add_new_normalized_title
- healthcare_clinical: 685 | action=add_new_normalized_title
...
- retail_sales: 147 | action=add_new_normalized_title
- customer_service: 130 | action=map_to_existing
- engineering_leadership: 94 | action=add_new_normalized_title

## Sample Files
- matched: `docs/title_recovery_pass_v54_semantic_patch/sample_title_matched_step13.jsonl`
- other: `docs/title_recovery_pass_v54_semantic_patch/sample_title_other_step13.jsonl`
- clusters: `docs/title_recovery_pass_v54_semantic_patch/title_other_clusters_step13.json`