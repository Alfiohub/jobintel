...
Input: `data/jobs/jobs_titled_en_shadow_esco_onet_v1.jsonl`
...
## Other Clusters
- other_long_tail: 32575 | action=keep_other
...
- compliance_risk: 366 | action=add_new_normalized_title
- education: 316 | action=add_new_normalized_title
- retail_sales: 151 | action=add_new_normalized_title
- customer_service: 103 | action=map_to_existing
- engineering_leadership: 94 | action=add_new_normalized_title

## Sample Files
- matched: `docs/title_shadow_pipeline_v1/sample_title_matched_step13.jsonl`
- other: `docs/title_shadow_pipeline_v1/sample_title_other_step13.jsonl`
- clusters: `docs/title_shadow_pipeline_v1/title_other_clusters_step13.json`