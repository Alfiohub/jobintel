...
16. `Principal Engineer` (16) | internal: `ml_engineer` 0.828 | ESCO: `ship assistant engineer` 1.0 | O*NET: `Logistics Engineers` 1.0 | action: `needs_tighter_rule`
...
19. `Senior Technical Enablement Architect` (15) | internal: `solutions_architect` 0.7636 | ESCO: `naval architect` 0.5783 | O*NET: `Computer Systems Engineers/Architects` 0.7636 | action: `needs_tighter_rule`
20. `Manager, Paid Social` (15) | internal: `marketing_specialist` 0.5236 | ESCO: `online community manager` 0.6522 | O*NET: `Public Relations Managers` 0.6522 | action: `keep_other_for_now`
...
- `keep_other_for_now`: `1901`
- `needs_tighter_rule`: `515`
- `semantic_layer_candidate`: `396`
- `taxonomy_gap`: `106`
...
- `FPGA Engineer` | vol `11` | target `electrical_engineer/industrial_engineering` | risk `low` | action `needs_tighter_rule`
...
- `Software Development Manager` | vol `10` | target `engineering_manager/software_engineering` | risk `low` | action `needs_tighter_rule`
